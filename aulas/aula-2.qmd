...
![Gráfico exportado](www/posit.png){fig-alt="Descrição da imagem"}

![](https://scs.usp.br/identidadevisual/wp-content/uploads/2022/08/usp-logo-png-1.png){fig-alt="Logo USP" width=50%}
*Figura 1: Fluxo de trabalho com Quarto*

* [Documentação Imagens Quarto](https://quarto.org/docs/authoring/figures.html)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/_f3latmOhew?si=om04jR-yMopnRBiU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Vídeo de Tutorial do Quarto
:::

<iframe width="560" height="315" src="https://quarto.org/docs/authoring/figures.html"></iframe>
...
Como mostrado na Figura @fig-elephant

Como mostrado na Figura @fig-plot

Como mostrado na equação @thm-line

* [Documentação Referências Quarto](https://quarto.org/docs/authoring/cross-references.html)
